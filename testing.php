...
$dsn = 'mysql:dbname=coffee_farmer;host=127.0.0.1;'; //database name
...
if($level == 1 or $level == 0){
    if($phone=='0726172579'){
         about($ussd_string_exploded,$phone);
}elseif($phone !='07261725798'){
